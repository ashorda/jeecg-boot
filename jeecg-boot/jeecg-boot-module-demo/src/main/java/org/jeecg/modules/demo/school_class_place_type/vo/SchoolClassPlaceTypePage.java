package org.jeecg.modules.demo.school_class_place_type.vo;
 ...
 */
@Data
@ApiModel(value="school_class_place_typePage对象", description="上课地点类型")
public class SchoolClassPlaceTypePage {
	...
	@ExcelCollection(name="上课地点管理")
	@ApiModelProperty(value = "上课地点管理")
	private List<SchoolPlaceCtrl> schoolPlaceCtrlList;
