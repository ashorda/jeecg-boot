...
@ApiModel(value="std_inf对象", description="学生信息")
public class StdInf implements Serializable {
	...
	/**班级*/
	@Excel(name = "班级", width = 15, dictTable = "class_inf", dicText = "class_name", dicCode = "id")
	@Dict(dictTable = "class_inf", dicText = "class_name", dicCode = "id")
	...
	/**年级班级*/
	@Excel(name = "年级班级", width = 15)
    @ApiModelProperty(value = "年级班级")
    private java.lang.String gradeClass;
}
